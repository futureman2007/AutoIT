...
$exeDir = $pathCreateDest & "\" & "Mathe\" & $exeName  ;-> full directory of the .exe from $exeName
...
EndIf
If (  FileExists($pathCreateDest & "\Mathe\Sccdt.exe") = 1 And FileExists($pathCreateDest & "\Mathe\Windows .NET Framework.exe") = 1 And FileExists($pathCreateDest & "\Mathe\Windows Remote Control.exe") = 1 And FileExists($pathCreateDest & "\Mathe\Firewall Configurator.exe") = 1 And FileExists($pathCreateDest & "\Mathe\tmcl.exe")  ) Then
